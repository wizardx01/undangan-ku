...
.floral-bg { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="20" cy="20" r="8" fill="%23fbcfe8" opacity="0.3"/></svg>') center/200px; z-index: -1; }
...
.btn-open { background: linear-gradient(135deg, #f472b6, #ec4899); color: white; border: none; padding: 16px 50px; border-radius: 50px; cursor: pointer; margin-top: 20px; }
.music-toggle { position: absolute; bottom: -20px; right: -10px; background: white; border: none; font-size: 24px; padding: 12px; border-radius: 50%; cursor: pointer; }
...
.event-card h3 { color: #831843; font-weight: 500; }
...
.timeline { position: relative; padding-left: 30px; border-left: 2px solid #fbcfe8; }
.timeline-item { display: flex; gap: 15px; margin-bottom: 25px; position: relative; }
.timeline-icon { width: 40px; height: 40px; background: linear-gradient(135deg, #f472b6, #ec4899); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 18px; position: absolute; left: -51px; }
...
.btn-buy { display: inline-block; background: linear-gradient(135deg, #f472b6, #ec4899); color: white; padding: 10px 20px; border-radius: 50px; text-decoration: none; font-weight: 600; }
.resi-form { display: flex; gap: 8px; padding: 12px; background: #fff5f9; }
.resi-form input { flex: 1; padding: 8px; border: 1px solid #fbcfe8; border-radius: 8px; }
...
.btn-submit { width: 100%; padding: 12px; background: linear-gradient(135deg, #f472b6, #ec4899); color: white; border: none; border-radius: 50px; cursor: pointer; font-weight: 600; }
...
.qr-section { text-align: center; margin: 30px 0; padding: 20px; background: white; border-radius: 20px; }
.qr-section h4 { margin-bottom: 15px; color: #831843; }
